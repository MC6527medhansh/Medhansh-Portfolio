...
export function DockDemo() {
  const handleGitHub = () => window.open('https://github.com/MC6527medhansh', '_blank');
  const handleLinkedIn = () => window.open('https://www.linkedin.com/in/medhanshchoubey', '_blank');
